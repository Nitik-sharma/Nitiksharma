      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-20">
          ...
          <p className={`text-base ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
            Ready to scale up your web conversions? Fill out my secure diagnostic form below or reach me directly on my channels.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                I respond to all custom bids and diagnostic scopes within 12 business hours. Standard quotes are produced free of charge. NDAs are completed immediately upon request.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="overflow-hidden">
                    ...
                    <span className={`text-sm font-semibold truncate block ${
                      isDarkMode ? 'text-slate-200 hover:text-cyan-400' : 'text-slate-800 hover:text-emerald-600'
                    }`}>
                      {chan.value}
                    </span>
                  </div>
          ...
          <div className="lg:col-span-7">
            <div className={`p-6 sm:p-10 rounded-3xl border backdrop-blur-2xl ${
              isDarkMode
              ...
              {isSuccess ? (
                ...
                <div className="text-center py-12 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h4 className={`font-display font-bold text-xl ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
                      Inquiry Scoped Successfully!
                    </h4>
                    <p className={`text-xs sm:text-sm max-w-md mx-auto ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                      Thank you for submitting your project specs. Nitik Sharma has been notified. I will review your database architecture needs and reach out within 12 business hours.
                    </p>
                  </div>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label className={`text-xs font-bold font-mono uppercase ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                        Your Name *
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <option value="basic">Growth Landing Page Scope (~$500)</option>
                        <option value="standard">React Applet Portal Integrations (~$1,300)</option>
                        <option value="premium">Enterprise MERN Database Systems (~$2,500+)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  >
                    <span>{isSubmitting ? 'Securing Package Encryption...' : 'Lock Milestone and Send Specs'}</span>
                    <Send size={14} />
                  </button>

                  <p className="text-[10px] text-center text-slate-500 font-mono">
                    Form submits securely via state mock. Rest assured, your message transmits.
                  </p>
